...
class PassengerScreen extends JFrame implements ActionListener {
    ...
    JLabel jLabelWelcome, jLabelSelectedView, jLabelChoose, titleLabel, timeLbl1, timeLbl2, timeLbl3, timeLbl4, timeLbl5;
    JLabel[] timeLbls;
    ...
    public PassengerScreen(String paramString) {
        ...
        jLabelSelectedView = new JLabel("Selected View: Information");
