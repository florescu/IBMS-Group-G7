...
class ControllerSetDelayViewScreen extends JFrame
    ...
    JButton jBtnResetDelay, jBtnSetDelay, jBtnResetCancel, jBtnDelay, jBtnSubmit, jBtnCancelView, jBtnReset;
    ...
    public ControllerSetDelayViewScreen(String paramString) {
        ...
        jBtnSetDelay.setBackground(lblBgClr);
        ...
        jBtnCancelView.setBackground(layoutBgClr);
